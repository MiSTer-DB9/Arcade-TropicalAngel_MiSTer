...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-TropicalAngel_MiSTer.git"
CORE_NAME=(Arcade-TropicalAngel)
...
UPSTREAM_CORE_NAME=(Arcade-TropicalAngel)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-TropicalAngel.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-TropicalAngel.rbf)
